...
np.random.seed(0)   # fixes which 50 malware samples get attacked
...
if __name__ == "__main__":
    clf = load_classifier("android-detectors/src/loaders/deeptrust_loader.py")
    metrics = iiia_evaluate(clf)
    print(json.dumps(metrics, indent=2, default=float))
    with open("iiia_metrics_deeptrust.json", "w") as f:
